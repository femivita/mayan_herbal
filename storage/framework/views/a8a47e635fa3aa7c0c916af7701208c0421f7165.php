<?php $__env->startSection('title', "Dashboard || Mayan-Herbal"); ?>

<?php $__env->startSection('breadtitle', "Dashboard"); ?>
...
<?php endif; ?>
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="myModalLabel2"><i class="la la-road2"></i> Upgrade to next Level (₦<?php echo e(number_format($pay_amount)); ?>)</h5>
                                  ...
                                  <div class="input-group">
                                                        <ul class="list-group col-sm-12">
                                                            <li class="list-group-item p-3" >
                                                                ...
                                                                <label for="flat-radio-1">Upgrade with Wallet Balance - <em><b>₦<?php echo e(number_format($pay_amount)); ?></b></em></label>
                                                            </li>
                                                            <li class="list-group-item p-3">
                          ...
                          data-target="#iconModal">How to?</a> -->
                                <table class="table mt-3">
                                    ...
                                    <tbody>
                                        <tr >
                                            <td>Level:</td>
                                            <td class="<?php echo e(Auth::user()->level == 0 ? 'text-danger' : ''); ?>"><?php echo e(Auth::user()->level == 0 ? "Not activated" : Auth::user()->level); ?></td>
                                        </tr>
                                       
                                        <tr >
                                            <td>Total Benefits:</td>
                                            <td class="text-success">₦<?php echo e(number_format($transIn)); ?></td>
                                        </tr>
                                      
                                        <tr >
                                            <td>Total Withdrawal:</td>
                                            <td class="text-danger">₦<?php echo e(number_format($transOut)); ?></td>
                                        </tr>
                                        <tr >
                                            <td>Joined:</td>
                                            <td class="text-dark"><?php echo e(date_format(date_create(Auth::user()->created_at),"d-M-Y")); ?></td>
                                        </tr>
                                        <?php if(Auth::user()->level > 0): ?>
                                        <tr >
                                            <td>Referral Link:</td>
                                            <td><a class="text-info" href="http://e-earners.com/register?ref=<?php echo e(Auth::user()->username); ?>">http://e-earners.com/register?ref=<?php echo e(Auth::user()->username); ?></a></td>
                                        </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table mt-3">
                                    ...
                                    <tbody>
                                        <tr >
                                            <td>Name:</td>
                                            <td><?php echo e(!$upline ? "Nil": $upline->name); ?></td>
                                        </tr>
                                        <tr >
                                            <td>Username:</td>
                                            <td><?php echo e(!$upline ? "Nil": $upline->username); ?></td>
                                        </tr>
                                        <tr >
                                            <td>Email:</td>
                                            <td><?php echo e(!$upline ? "Nil": $upline->email); ?></td>
                                        </tr>
                                        <tr >
                                        <td>Phone:</td>
                                            <td><?php echo e(!$upline ? "Nil": $upline->phone); ?></td>
                                        </tr>
  ...
  function payWithPaystack(){
    var handler = PaystackPop.setup({
      key: '<?php echo e($paystack_key); ?>',
      email: '<?php echo e(Auth::user()->email); ?>',
      amount: <?php echo e($pay_amount * 100); ?>,
      currency: "NGN",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mayan_herbal\resources\views/home2.blade.php ENDPATH**/ ?>