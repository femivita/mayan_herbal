...
<head>
    ...
    <title>Login || Mayan_Herbal</title>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="remember" id="customCheck1" <?php echo e(old('remember') ? 'checked' : ''); ?>>
...
</html><?php /**PATH C:\xampp\htdocs\mayan_herbal\resources\views/auth/login.blade.php ENDPATH**/ ?>