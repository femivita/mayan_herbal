...
<head>
    ...
    <link rel="shortcut icon" type="image/png" sizes="16x16" href="<?php echo e(asset('assets/images/favicon.png')); ?>">
...
<body class="skin-blue fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Mayan Herbal</p>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/assets/images/users/default.png" alt="user" class=""> <span class="hidden-md-down"><?php echo e(AUth::user()->username); ?> &nbsp;<i class="fa fa-angle-down"></i></span> </a>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <!-- <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="/assets/images/users/default.png" alt="user-img" class="img-circle"><span class="hide-menu"><?php echo e(Auth::user()->username); ?></span></a>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor"><?php echo $__env->yieldContent('breadtitle'); ?></h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                               <?php echo $__env->yieldContent('breadli'); ?>
                            </ol>
        ...
        <!-- ============================================================== -->
        <footer class="footer">
            © 2020 Mayan Herbal, All Rights Reserved.
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
...
</html><?php /**PATH C:\xampp\htdocs\mayan_herbal\resources\views/layouts/web.blade.php ENDPATH**/ ?>